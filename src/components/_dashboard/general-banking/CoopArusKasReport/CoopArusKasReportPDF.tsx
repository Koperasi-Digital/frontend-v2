  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View>
          <Text style={[styles.overline]}>Laporan Arus Kas Koperasi</Text>
        </View>
        <View style={styles.table}>
          ...
          <View style={styles.tableBody}>
            <View style={styles.tableRow}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.subtitle2}>
                  {fCurrency(props.coopArusKasData.jumlahKasAwal)}
                </Text>
              </View>
            </View>
            <View style={styles.tableRow}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.subtitle2}>{fCurrency(props.coopArusKasData.kasMasuk)}</Text>
              </View>
            </View>
            <View style={styles.tableRow}>
              <View style={styles.tableCell_1}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.subtitle2}>
                  {fCurrency(props.coopArusKasData.jumlahKasAkhir)}
                </Text>
              </View>
            </View>
          </View>
